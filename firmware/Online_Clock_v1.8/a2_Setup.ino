...
void setup() {
  ...
  randomSeed(analogRead(ANALOG_PR));  // Инициализируем генератор псевдослучайных чисел с получением RAW значения от PR датчика (для рандомных цветов на сегментах)
}