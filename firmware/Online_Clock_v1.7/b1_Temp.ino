...
//Функция вызывается при нажатии кнопки "SET" на часах (поднимает флаг для переключения с часов на температуру на указанное в "time_temp" кол-во миллисекунд и обновляет время для таймера возврата обратно к часам)
void ShowTemp() {
